...
var Model = ModelType{
	4, map[string]CoefficientsMatrix{ // baati / "kind-worker"
		"kind-control-plane\n": CoefficientsMatrix{{0.09236406129745652, 0.06968222664414211, 0.1647130881065321, 0.20015221017304366},
		...
		"kind-worker": CoefficientsMatrix{{0.0437716396715501, 0.05309571481979834, 0.05778327994778269, 0.0478036633107744},
